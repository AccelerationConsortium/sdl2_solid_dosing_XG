...
- JSON files for usage stats only: data/sdl2_components/component_name_usage.json
- Log files for component activity: data/sdl2_components/component_name_history.log
...
class ComponentManager:
    ...
    def __init__(self, data_dir: Path = None):
        self.data_dir = data_dir or Path(__file__).resolve().parents[2] / "data" / "sdl2_components"
