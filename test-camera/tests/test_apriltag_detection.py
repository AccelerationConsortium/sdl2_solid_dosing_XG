...
class AprilTagDetector:
    ...
    def __init__(self, tag_family='tag41h12', tag_size_mm=23.0, calibration_file=None):
        """
...
def main():
    ...
    parser.add_argument('--config', default='camera_client_config.yaml',
    ...
    parser.add_argument('--tag-family', default='tag41h12',
                       choices=['tag36h11', 'tag25h9', 'tag16h5', 'tag41h12'],
