...
def demo_flex(simulation: bool = True):
    # Print available deck slots for debugging
    ...
    tips=[
        {"nickname": "tip_1000_96_1", "loadname": "opentrons_flex_96_filtertiprack_1000ul", "location": "D2", "ot_default": True, "config": {}}
    ]
    ...
    ot.get_location_from_labware(labware_nickname="tip_1000_96_1", position= "A3", top=0)
